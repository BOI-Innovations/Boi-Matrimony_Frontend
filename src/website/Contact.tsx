            ...
            >
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <a href="tel:07266858699" className="text-muted-foreground text-sm hover:text-primary transition-colors">
                    07266858699
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  ...
                  <a href="mailto:support@brahminmatrimony.com" className="text-muted-foreground text-sm hover:text-primary transition-colors">
                    support@brahminmatrimony.com
                  </a>
                </div>
              </div>
