      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2" data-field="firstName">
          ...
          <Input
            ...
            className={cn(
              validationErrors.has("firstName") && "border-red-500 border-2 focus:border-red-500"
            )}
        ...
        <div className="space-y-2" data-field="lastName">
          ...
          <Input
            ...
            className={cn(
              validationErrors.has("lastName") && "border-red-500 border-2 focus:border-red-500"
            )}
        ...
        <div className="space-y-2" data-field="placeOfBirth">
          ...
          <Input
            ...
            className={cn(
              validationErrors.has("placeOfBirth") && "border-red-500 border-2 focus:border-red-500"
            )}
