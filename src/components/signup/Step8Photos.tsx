...
/* ------------------------------------------------------------
 * 🔹 Step8Photos Component for Signup
 * ------------------------------------------------------------ */
...
const Step8Photos = ({ data, onNext, onBack, isFirstStep, isLastStep }: Step8PhotosProps) => {
    ...
    const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (res.ok && data.statusCode === 200) {
                toast({ description: "Profile picture uploaded successfully!" });
    ...
    /* ------------------------------------------------------------
     * 🔹 Handle Next (Complete Signup)
     * ------------------------------------------------------------ */
    const handleComplete = () => {
        // Collect photo data if needed, but since uploads are done, just proceed
        onNext({});
    };
