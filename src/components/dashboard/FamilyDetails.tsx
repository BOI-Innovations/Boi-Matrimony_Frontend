...
const FamilyDetails = () => {
  ...
  const handleSave = async () => {
    ...
    if (formData.parentsContactNo) {
      const phoneError = validatePhoneNumber(formData.parentsContactNo, "Parents Contact");
      if (phoneError) {
              ...
              >
                ...
                {editMode ? (
                  item.field === "familyValue" ? (
                    ...
                    <Input
                      type={typeof formData[item.field as keyof FamilyDetailsData] === "number" ? "number" : "tel"}
